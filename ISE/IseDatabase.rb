...
# puts ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
# puts "Hello from lib/IseDatabase.rb"
...
## See also:  http://groups.google.com/group/compositekeys/browse_thread/thread/8a21e996b9de8bc9
  require 'activerecord'	## GEM: from Rails, Object Relationship Manager (ORM) on top of the back-end RDBMS
