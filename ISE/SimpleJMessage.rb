...
class SimpleJMessage < IseMessage
  ...
  def pack_message(details=false)
    ...
    @simplej_header.pack_message(details)          # if @simplej_header.out.empty?

    @simplej_link16_header.pack_message(details)   # if @simplej_link16_header.out.empty?
    @link16_message.pack_message(details)         # if @link16_message.out.empty?
