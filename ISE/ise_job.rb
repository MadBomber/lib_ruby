...
class IseJob
  ...
  def self.replace(name, desc=nil)
    ...
    begin
      ...
      new_ise_job.desc = desc.nil? ? job.desc : desc  ## allows replacing a job using a different description
