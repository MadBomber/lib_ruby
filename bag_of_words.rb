# ~/lib/ruby/bag_of_words.rb

# gem 'stopwords_filters'
require 'stopwords'     # SMELL: this is very old
require 'fast_stemmer'
require 'narray'

# A class that represents a collection of text documents
# and provides methods to process and analyze the words 
...
class BagOfWords
  ...
  def initialize(opts = {})
    ...
    # FIXME:  The stopwords gem no longer has a Snowball class
