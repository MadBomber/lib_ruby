# ~/lib/ruby/tests/api_key_manager_test.rb
...
class TestRate < Minitest::Test
  ...
  def test_api_key_returns_a_key
    rate = ApiKeyManager::Rate.new(api_keys: @api_keys)
  ...
  def test_api_key_returns_a_new_key_after_rate_count
    rate = ApiKeyManager::Rate.new(api_keys: @api_keys, rate_count: 2)
  ...
  def test_api_key_returns_a_new_key_after_rate_period
    rate = ApiKeyManager::Rate.new(api_keys: @api_keys, rate_period: 3)
